...
export default {
	...
	$getAuth0Preferences: createRequestReducer(
		AppConstants.APP.UI_BUILDER.AUTH0.GET_AUTH0_PREFERENCES,
	...
	$saveAuth0Preferences: createRequestReducer(
		AppConstants.APP.UI_BUILDER.AUTH0.SET_AUTH0_PREFERENCES,
	...
	$getAuth0Client: createRequestReducer(
		AppConstants.APP.UI_BUILDER.AUTH0.GET_AUTH0_CLIENT,
		AppConstants.APP.UI_BUILDER.AUTH0.GET_AUTH0_CLIENT_SUCCESS,
		AppConstants.APP.UI_BUILDER.AUTH0.GET_AUTH0_CLIENT_ERROR,
	),
	$saveAuth0Client: createRequestReducer(
		AppConstants.APP.UI_BUILDER.AUTH0.UPDATE_AUTH0_CLIENT,
	...
	$createAuth0Client: createRequestReducer(
		AppConstants.APP.UI_BUILDER.AUTH0.CREATE_AUTH0_CLIENT,
	...
	$getAuth0ClientConnections: createRequestReducer(
		AppConstants.APP.UI_BUILDER.AUTH0.GET_AUTH0_CLIENT_CONNECTIONS,
	...
	$saveAuth0ClientConnections: createRequestReducer(
		AppConstants.APP.UI_BUILDER.AUTH0.SAVE_AUTH0_CLIENT_CONNECTIONS,
	...
	$createAuth0ClientConnection: createRequestReducer(
		AppConstants.APP.UI_BUILDER.AUTH0.CREATE_AUTH0_CLIENT_CONNECTION,
	...
	$updateAuth0ClientConnection: createRequestReducer(
		AppConstants.APP.UI_BUILDER.AUTH0.UPDATE_AUTH0_CLIENT_CONNECTION,
	...
	$getAuth0ClientConnection: createRequestReducer(
		AppConstants.APP.UI_BUILDER.AUTH0.GET_AUTH0_CLIENT_CONNECTION,
	...
	$getAuth0Users: createRequestReducer(
		AppConstants.APP.UI_BUILDER.AUTH0.GET_AUTH0_USERS,
		AppConstants.APP.UI_BUILDER.AUTH0.GET_AUTH0_USERS_SUCCESS,
		AppConstants.APP.UI_BUILDER.AUTH0.GET_AUTH0_USERS_ERROR,
	),
	$createAuth0User: createRequestReducer(
		AppConstants.APP.UI_BUILDER.AUTH0.CREATE_AUTH0_USER,
		AppConstants.APP.UI_BUILDER.AUTH0.CREATE_AUTH0_USER_SUCCESS,
		AppConstants.APP.UI_BUILDER.AUTH0.CREATE_AUTH0_USER_ERROR,
	),
	$updateAuth0User: createRequestReducer(
		AppConstants.APP.UI_BUILDER.AUTH0.UPDATE_AUTH0_USER_SETTINGS,
	...
	$deleteAuth0User: createRequestReducer(
		AppConstants.APP.UI_BUILDER.AUTH0.DELETE_AUTH0_USER,
		AppConstants.APP.UI_BUILDER.AUTH0.DELETE_AUTH0_USER_SUCCESS,
	...
	$saveSearchPreference: createRequestReducer(
	...
	$saveRecommendationPreference: createRequestReducer(
	...
	$deleteSearchPreference: createRequestReducer(
	...
	$getSearchPreferencesVersions: getSearchPreferencesVersions,
	$deleteRecommendationPreference: createRequestReducer(
